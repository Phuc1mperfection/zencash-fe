...
const formSchema = z.object({
  goalAmount: z.coerce.number().positive({ message: "Amount must be greater than 0." }),
  categoryGroupId: z.coerce.number({ message: "Please select a category group." }),
...
export function GoalSpendingForm({
  ...
  const { groups: categoryGroups } = useCategoryGroup();
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Choose the category group this goal applies to.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />

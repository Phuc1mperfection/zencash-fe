  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-[#001e2b] to-[#023430] flex items-center justify-center">
      <div className="relative">
        ...
        {/* Inner Ring */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full border-4 border-[#00ed64] animate-spin border-t-transparent"></div>
